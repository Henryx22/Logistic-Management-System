...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $notifiation = notify('usuario creado exitosamente');
    ...
    public function update(Request $request, User $user)
    {
        ...
        $user->assignRole($request->role);
        $notification = notify('Usuario editado correctamente');
    ...
    public function updateProfile(Request $request,User $user){
        ...
        $notification = notify('Perfil editado correctamente');
    ...
    public function updatePassword(Request $request, User $user)
    {
        ...
        if ($verify_password) {
            ...
            $notification = notify('Contraseña editada correctamente!!!');
            $logout = auth()->logout();
            return back()->with($notification, $logout);
        } elseif(!$verify_password) {
            $notification = notify("Contraseña Incorrecta!!!",'danger');
