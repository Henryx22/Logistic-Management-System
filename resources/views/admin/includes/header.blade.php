...
<div class="header">
	...
	<div class="header-left">
		...
		<a href="{{route('dashboard')}}" class="logo logo-small">
			<img src="{{asset('assets/img/logo-dash.png')}}" alt="Logo" width="30" height="30">
		</a>
	</div>
	<!-- /Logo -->
	...
	<ul class="nav user-menu">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<p class="noti-details">
												<span class="noti-title"> Solo quedan {{$notification->data['quantity']}} unidades de {{$notification->data['product_name']}}.</span>
												<span>Por favor actualice la cantidad de compra (the purchase quantity) </span>
											</p>
		...
		<li class="nav-item dropdown has-arrow">
			...
			<div class="dropdown-menu">
				...
				@can('view-settings')<a class="dropdown-item" href="{{route('settings')}}">Ajustes</a>@endcan
